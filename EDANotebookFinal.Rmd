...
---
# Introduction (MIGHT NEED TO ADD MORE DETAILS FROM OUR RESEARCH PROPOSAL?)  
...
Although the dataset is publicly available, it is essential to approach the analysis with ethical responsibility. Since the stress levels and demographic factors are complex and influenced by various social, economic, and cultural contexts, we should be mindful of potential biases in self-reported data, as responses may be affected by individual perceptions, societal expectations, or access to mental health resources. It is also important to avoid reinforcing stereotypes about stress levels across age groups, gender identities, or regions. Additionally, disparities in mental health awareness and care should be acknowledged, as they may impact the patterns observed in the data. Therefore, ensuring responsible interpretation and presentation of findings is crucial to prevent misrepresentation and contribute to a more accurate and ethical understanding of stress distribution.
...
# Data Cleaning
Since the dataset contains about 4050 attributes, we decided to select variables that are relevant to our research. 
...
To understand the gender distribution for the participants of the survey, we performed analysis on the gender identities of the participants.
...
Respondents who selected 1 for 'Male' or 'Female' are nowcategorized accordingly. The other three response categories (Transgender, Other_Gender, Non_Binary) can be disregarded as we have confirmed above that all respondents answered the ""How do you describe yourself?" question as either Male or Female. 
...
To understand where in the US the survey's participants are from, we performed exploratory analysis of respondents metropolitan origin.
